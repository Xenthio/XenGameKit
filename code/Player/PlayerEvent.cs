...
public static partial class Local
{
	public interface IPlayerEvents : ISceneEvent<IPlayerEvents>
	{
		...
		void OnWeaponAdded( BaseCarryable weapon ) { }
		void OnWeaponRemoved( BaseCarryable weapon ) { }
...
public static partial class Global
{
	public interface IPlayerEvents : ISceneEvent<IPlayerEvents>
	{
		...
		void OnPlayerWeaponAdded( Player player, BaseCarryable weapon ) { }
		void OnPlayerWeaponRemoved( Player player, BaseCarryable weapon ) { }
	}
}
